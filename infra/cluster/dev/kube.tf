/**
  * Credits: https://github.com/kube-hetzner/
  * ./terraform-hcloud-kube-hetzner/blob/2975302f890da13e1c179600049bac1a1600e4ee/kube.tf.example
  */
locals {
...
module "kube-hetzner" {
  ...
  microos_x86_snapshot_id = "247020713"
  microos_arm_snapshot_id = "247020672"
